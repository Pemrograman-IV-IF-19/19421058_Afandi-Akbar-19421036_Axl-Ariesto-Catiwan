...
class _DetailTransaksiScreens extends State<DetailTransaksiScreens> {
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                return _detailTransaksi(
                  "$baseUrl/gambar-mobil/${detailTransaksi[index]['mobil']['gambar']}",
                  detailTransaksi[index]['mobil']['namaMobil'],
                  detailTransaksi[index]['mobil']['harga'],
                  detailTransaksi[index]['tanggalSewa'],
                  detailTransaksi[index]['lamaSewaPerhari'],
  ...
  Widget _detailTransaksi(
      String gambar, String nama, harga, tanggalSewa, lamaSewaPerhari, subTotal, int index) {
    return FadeInDown(
