...
import 'package:uas_rental_mobil/Screens/Features/USERS/Transaksi/DetailTransaksi.dart';
...
class _TransaksiScreens extends State<TransaksiScreens> {
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return _transaksi(
                        ...
                        dataTransaksi[index]['user']['namaLengkap'],
  ...
  Widget _transaksi(String id, namaLengkap, total, data, int index) {
    return FadeInDown(
          ...
          children: <Widget>[
            Expanded(
              ...
              children: <Widget>[
                ...
                Text(
                  DetailTransaksiPage.dataTransaksi['user']['namaLengkap'],
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),
                ),
                SizedBox(
                  height: 10,
